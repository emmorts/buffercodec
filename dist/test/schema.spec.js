...
describe('#schema', () => {
    it('should encode an int8', () => {
        ...
        const schema = new lib_1.BufferSchema({
            foo: 'int8'
        });
        const schemaBuffer = schema.encode({
            foo: 0x7F
        });
        const areEqual = utils_1.areBuffersEqual(schemaBuffer, expectedBuffer);
    ...
    it('should encode a nested array of primitives', () => {
        ...
        const expectedBuffer = new lib_1.BufferCodec()
    ...
    it('should decode a complex object', () => {
        ...
        expect(decodedObject).to.roughly.deep.eq({
            int8Test: 0x7F,
            uint8Test: 0xFF,
            int16leTest: 0x7FFF,
            int16beTest: 0x7FFF,
